...
namespace IIS.Medosmotry
{
    ...
    public class СписокНаМедосм : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Medosmotry.DetailArrayOfКонтингентСотр fКонтингентСотр;
        ...
        public virtual IIS.Medosmotry.DetailArrayOfКонтингентСотр КонтингентСотр
        {
            get
            {
                ...
                {
                    this.fКонтингентСотр = new IIS.Medosmotry.DetailArrayOfКонтингентСотр(this);
                }
                IIS.Medosmotry.DetailArrayOfКонтингентСотр result = this.fКонтингентСотр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СписокНаМедосмE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СписокНаМедосмE", typeof(IIS.Medosmotry.СписокНаМедосм));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СписокНаМедосмL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СписокНаМедосмL", typeof(IIS.Medosmotry.СписокНаМедосм));
                }
            }
        }
    }

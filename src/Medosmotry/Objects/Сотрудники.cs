...
namespace IIS.Medosmotry
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Medosmotry.ПолСотрудника fПол;
        ...
        private IIS.Medosmotry.Должности fДолжности;
        ...
        public virtual IIS.Medosmotry.ПолСотрудника Пол
        {
            get
            {
                ...
                IIS.Medosmotry.ПолСотрудника result = this.fПол;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Medosmotry.Должности Должности
        {
            get
            {
                ...
                IIS.Medosmotry.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Medosmotry.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Medosmotry.Сотрудники));
                }
            }
        }
    }

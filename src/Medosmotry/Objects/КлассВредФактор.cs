    ...
    public class КлассВредФактор : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлассВредФакторE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлассВредФакторE", typeof(IIS.Medosmotry.КлассВредФактор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлассВредФакторL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлассВредФакторL", typeof(IIS.Medosmotry.КлассВредФактор));
                }
            }
        }
    }

...
namespace IIS.Medosmotry
{
    ...
    [MasterViewDefineAttribute("ВреднФактПроизE", "КлассВредФактор", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "ВредныйФактор")]
    public class ВреднФактПроиз : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Medosmotry.ИндНапрМедосм fИндНапрМедосм;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Medosmotry.ИндНапрМедосм.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ИндНапрМедосм"})]
        public virtual IIS.Medosmotry.ИндНапрМедосм ИндНапрМедосм
        {
            get
            {
                ...
                IIS.Medosmotry.ИндНапрМедосм result = this.fИндНапрМедосм;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВреднФактПроизE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВреднФактПроизE", typeof(IIS.Medosmotry.ВреднФактПроиз));
                }
            }
        }
    }
    ...
    public class DetailArrayOfВреднФактПроиз : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Medosmotry.DetailArrayOfВреднФактПроиз members)

        // *** End programmer edit section *** (IIS.Medosmotry.DetailArrayOfВреднФактПроиз members)
        ...
        /// </summary>
        public DetailArrayOfВреднФактПроиз(IIS.Medosmotry.ИндНапрМедосм fИндНапрМедосм) : 
                base(typeof(ВреднФактПроиз), ((ICSSoft.STORMNET.DataObject)(fИндНапрМедосм)))
        {
        }
        
        public IIS.Medosmotry.ВреднФактПроиз this[int index]
        {
            get
            {
                return ((IIS.Medosmotry.ВреднФактПроиз)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Medosmotry.ВреднФактПроиз dataobject)
        {

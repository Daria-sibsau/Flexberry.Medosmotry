    ...
    public class МедУчреждение : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МедУчреждениеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МедУчреждениеE", typeof(IIS.Medosmotry.МедУчреждение));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МедУчреждениеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МедУчреждениеL", typeof(IIS.Medosmotry.МедУчреждение));
                }
            }
        }
    }

...
namespace IIS.Medosmotry
{
    ...
    public class ИндНапрМедосм : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Medosmotry.Организации fОрганизации;
        
        private IIS.Medosmotry.Сотрудники fСотрудники;
        
        private IIS.Medosmotry.МедУчреждение fМедУчреждение;
        
        private IIS.Medosmotry.DetailArrayOfВреднФактПроиз fВреднФактПроиз;
        ...
        [PropertyStorage(new string[] {
                "МедУчреждение"})]
        [NotNull()]
        public virtual IIS.Medosmotry.МедУчреждение МедУчреждение
        {
            get
            {
                ...
                IIS.Medosmotry.МедУчреждение result = this.fМедУчреждение;
        ...
        [PropertyStorage(new string[] {
                "Организации"})]
        [NotNull()]
        public virtual IIS.Medosmotry.Организации Организации
        {
            get
            {
                ...
                IIS.Medosmotry.Организации result = this.fОрганизации;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Medosmotry.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Medosmotry.Сотрудники result = this.fСотрудники;
        ...
        public virtual IIS.Medosmotry.DetailArrayOfВреднФактПроиз ВреднФактПроиз
        {
            get
            {
                ...
                {
                    this.fВреднФактПроиз = new IIS.Medosmotry.DetailArrayOfВреднФактПроиз(this);
                }
                IIS.Medosmotry.DetailArrayOfВреднФактПроиз result = this.fВреднФактПроиз;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИндНапрМедосмE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИндНапрМедосмE", typeof(IIS.Medosmotry.ИндНапрМедосм));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ИндНапрМедосмL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИндНапрМедосмL", typeof(IIS.Medosmotry.ИндНапрМедосм));
                }
            }
        }
    }

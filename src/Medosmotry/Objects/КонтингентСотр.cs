...
namespace IIS.Medosmotry
{
    ...
    public class КонтингентСотр : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Medosmotry.ПериодМед fПериодичность;
        
        private IIS.Medosmotry.ПриказМЗР fПриказМЗР;
        
        private IIS.Medosmotry.КлассВредФактор fКлассВредФактор;
        
        private IIS.Medosmotry.Подразделение fПодразделение;
        
        private IIS.Medosmotry.СписокНаМедосм fСписокНаМедосм;
        ...
        public virtual IIS.Medosmotry.ПериодМед Периодичность
        {
            get
            {
                ...
                IIS.Medosmotry.ПериодМед result = this.fПериодичность;
        ...
        [PropertyStorage(new string[] {
                "КлассВредФактор"})]
        [NotNull()]
        public virtual IIS.Medosmotry.КлассВредФактор КлассВредФактор
        {
            get
            {
                ...
                IIS.Medosmotry.КлассВредФактор result = this.fКлассВредФактор;
        ...
        [PropertyStorage(new string[] {
                "Подразделение"})]
        [NotNull()]
        public virtual IIS.Medosmotry.Подразделение Подразделение
        {
            get
            {
                ...
                IIS.Medosmotry.Подразделение result = this.fПодразделение;
        ...
        [PropertyStorage(new string[] {
                "ПриказМЗР"})]
        [NotNull()]
        public virtual IIS.Medosmotry.ПриказМЗР ПриказМЗР
        {
            get
            {
                ...
                IIS.Medosmotry.ПриказМЗР result = this.fПриказМЗР;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Medosmotry.СписокНаМедосм.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "СписокНаМедосм"})]
        public virtual IIS.Medosmotry.СписокНаМедосм СписокНаМедосм
        {
            get
            {
                ...
                IIS.Medosmotry.СписокНаМедосм result = this.fСписокНаМедосм;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтингентСотрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтингентСотрE", typeof(IIS.Medosmotry.КонтингентСотр));
                }
            }
        }
    }
    ...
    public class DetailArrayOfКонтингентСотр : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Medosmotry.DetailArrayOfКонтингентСотр members)

        // *** End programmer edit section *** (IIS.Medosmotry.DetailArrayOfКонтингентСотр members)
        ...
        /// </summary>
        public DetailArrayOfКонтингентСотр(IIS.Medosmotry.СписокНаМедосм fСписокНаМедосм) : 
                base(typeof(КонтингентСотр), ((ICSSoft.STORMNET.DataObject)(fСписокНаМедосм)))
        {
        }
        
        public IIS.Medosmotry.КонтингентСотр this[int index]
        {
            get
            {
                return ((IIS.Medosmotry.КонтингентСотр)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Medosmotry.КонтингентСотр dataobject)
        {
